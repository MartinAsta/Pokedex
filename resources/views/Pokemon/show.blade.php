        ...
        <div class="flex flex-col ml-0 lg:ml-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                @if($pokemon->move1 && $pokemon->move1->type)
                    <div class="rounded-lg shadow-lg p-4" style="background-color: {{ $pokemon->move1->type->colour }};">
                ...
                @if($pokemon->move2 && $pokemon->move2->type)
                    <div class="bg-white rounded-lg shadow-lg p-4"
                        style="background-color: {{ $pokemon->move2->type->colour }};">
                        <div class="flex items-center">
                ...
                @if($pokemon->move3 && $pokemon->move3->type)
                    <div class="bg-white rounded-lg shadow-lg p-4"
                        style="background-color: {{ $pokemon->move3->type->colour }};">
                        <div class="flex items-center">
                ...
                @if($pokemon->move4 && $pokemon->move4->type)
                    <div class="bg-white rounded-lg shadow-lg p-4"
                        style="background-color: {{ $pokemon->move4->type->colour }};">
                        <div class="flex items-center">
