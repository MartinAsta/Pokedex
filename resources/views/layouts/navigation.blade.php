<nav x-data="{ open: false }" class="bg-red-500 border-b border-red-500">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.pokemon.index')" :active="request()->routeIs('pokemon.*')">
                {{ __('Pokemon') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.types.index')" :active="request()->routeIs('types.*')">
                {{ __('Types') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.moves.index')" :active="request()->routeIs('moves.*')">
                {{ __('Attaques') }}
            </x-responsive-nav-link>
